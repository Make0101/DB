...
pid int,
category_id int,
constraint pid_f_key foreign key (pid) references model(id),
constraint category_id_f_key foreign key (category_id) references category(id)
);
...
imgs_id int,
constraint pid_f_key foreign key (pid) references model(id),
constraint imgs_id foreign key (imgs_id) references imgs(id)
);
